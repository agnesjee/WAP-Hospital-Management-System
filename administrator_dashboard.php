...
<br/><br/><br/><br/>
  ...
  <a href="administrator_dashboard.php" style="color: #FFFFFF;" >Dashboard</a>
  <a href="administrator_view_employee.php">View Employee List</a>
</div>

<div class = "headerImage">
  <br/>
  <span class = "pageTitle">&nbsp;Dashboard</span><br/>
  <span class = "pageSubtitle" style="font-size: 30px; font-weight: bold; margin-left: 15px; color: #242020;">&nbsp;&nbsp;Welcome to Administrator Portal !</span>
